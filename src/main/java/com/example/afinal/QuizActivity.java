...
public class QuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String msg="정답입니다!!";
        Button btn1 = (Button) findViewById(R.id.option1);
        Button btn2 = (Button) findViewById(R.id.option2);
        Button btn3 = (Button) findViewById(R.id.option3);
        Button btn4 = (Button) findViewById(R.id.option4);
        Button btn5 = (Button) findViewById(R.id.nextbutton5);
        TextView textView1=findViewById(R.id.timer1);
        textView2=findViewById(R.id.question);

        CountDownTimer countDownTimer=new CountDownTimer(10000,1000) {
            @Override
            public void onTick(long milliUntilFinished) {
                int num=(int) (milliUntilFinished/1000);
                textView1.setText("남은 시간:"+Integer.toString(num+1)+"초");
            }
            ...
            public void onInit(int status) {
                if(status==TextToSpeech.SUCCESS){
                    ...
                    if(result==TextToSpeech.LANG_MISSING_DATA || result==TextToSpeech.LANG_NOT_SUPPORTED){
                        Toast.makeText(QuizActivity.this,"이 언어는 지원하지 않습니다.",Toast.LENGTH_SHORT).show();
                    }else{
        ...
        btn2.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                if (motionEvent.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    btn2.setBackgroundColor(Color.parseColor("#64CD3C"));
    ...
    public void nextbutton2(View v) {
